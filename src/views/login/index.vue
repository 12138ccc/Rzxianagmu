<template>
  <div class="login-container">
    <el-form ref="loginForm" class="login-form" auto-complete="on" label-position="left" :model="loginForm" :rules="rules">
      ...
      <el-button class="loginBtn" style="width:100% ;margin-bottom:30px;border:none;color:#fff" :loading="loading" @click="login">登录</el-button>
      <div class="tips">
    ...
    return {
      ...
      rules: {
        ...
        password: [
          ...
          { min: 6, max: 16, message: '密码必格式不对', trigger: 'blur' }
        ]
      }
    }
  },
