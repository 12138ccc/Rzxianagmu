...
<script>
import { getEmployeeInfo as getPersonalDetail, getEmployeeJobsAPI as getJobDetail } from '@/api/employees'
import { getUserById as getUserDetailById } from '@/api/user'
export default {
  data() {
    return {
      formData: {},
