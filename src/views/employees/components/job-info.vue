<template>
  <div class="job-info">
    ...
    <el-form label-width="220px">
      ...
      <!-- 从业信息 -->
      <el-form-item>
        <el-button type="primary" @click="saveEmployeeJobs">保存更新</el-button>
...
import { getEmployeeJobsAPI, saveEmployeeJobsAPI } from '@/api/employees'
export default {
  data() {
    return {
  ...
  methods: {
    async getEmployeeJobs() {
      this.formData = await getEmployeeJobsAPI(this.userId)
    },
    async saveEmployeeJobs() {
      await saveEmployeeJobsAPI(this.formData)
